...
codes = ['ROSE/USDT', 'AAVE/USDT', 'FLOW/USDT', 'XMR/USDT', '1INCH/USDT', 'KLAY/USDT', 
         ...
         'ZEN/USDT', 'STG/USDT' , 'TRU/USDT', 'ASTR/USDT', 'EGLD/USDT', 'IMX/USDT' , 'RNDR/USDT', 'JUP/USDT', 'CYBER/USDT', 'ACH/USDT',
         'OM/USDT', 'SAGA/USDT', 'OMNI/USDT', 'RDNT/USDT', 'RSR/USDT', 'ARK/USDT', 'XTZ/USDT', 'SFP/USDT', 'YFI/USDT',
         'AXL/USDT', 'DYDX/USDT', 'TIA/USDT', 'AVAX/USDT', 'ACE/USDT', 'POLYX/USDT']
