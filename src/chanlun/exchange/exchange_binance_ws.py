...
async def subscribe(url, subs, callback):
...
async def handler(data):
    ...
    {'stream': '!bookTicker',
     'data': {'e': 'bookTicker', 'u': 950106938444, 's': 'LRCUSDT',
              'b': '2.45119', 'B': '199', 'a': '2.45187', 'A': '1498',
              'T': 1637313831505, 'E': 1637313831512}}
    """
...
class ExchangeBinanceWS(Exchange):
    g_all_stocks = []
    ...
    def __init__(self) -> None:
        ...
        self.args = [
        "!markPrice@arr",  # 全市场最新标记价格 3s, !markPrice@arr 或 !markPrice@arr@1s
        # "!miniTicker@arr",  # 全市场的精简Ticker
        "!ticker@arr",  # 全市场的完整Ticker
        # "bnbusdt@miniTicker",  # 按Symbol的精简Ticker
        # "bnbusdt@ticker",  # 按Symbol的完整Ticker
        # "bnbbusd@ticker",
        # "!bookTicker",
        # "btcusdt@depth20@100ms",
        # "btcusdt_perpetual@continuousKline_1h",
        # "btcusdt_perpetual@continuousKline_4h",
        # "btcusdt_perpetual@continuousKline_1d",
        ]
        self.subs = {
        "method": "SUBSCRIBE",
        "params": self.args,
...
def main():
    url = 'wss://fstream.binance.com/stream'  # 合约
    # url = 'wss://fstream.yshyqxx.com/stream'  # https://www.binancezh.top/  开发测试网址，合约
    # url = 'wss://stream.yshyqxx.com/stream'  # 开发测试网址，现货
    args = [
        "!markPrice@arr",  # 全市场最新标记价格 3s, !markPrice@arr 或 !markPrice@arr@1s
        # "!miniTicker@arr",  # 全市场的精简Ticker
        "!ticker@arr",  # 全市场的完整Ticker
